...
This folder is the region-default content layer for `reg36`.
...
- `regions/reg36/data/primary-assets.json`
- `regions/reg36/data/primary.json`
- `regions/reg36/data/footer.json`
- `regions/reg36/data/primaryending.json`
- `regions/reg36/assets/primary/manifest.json`
- `regions/reg36/assets/footer/manifest.json`
...
Use this folder for region-wide defaults that should affect `reg36`.
